...
export const DashboardHeader = () => {
  ...
  return (
    <div
      className={
        "flex gap-2 justify-center items-center p-2 rounded-3xl relative z-1000 bg-(--background-container) backdrop-blur-lg border border-(--border-color) shadow-md max-md:flex-col max-md:text-center"
      }
    >
